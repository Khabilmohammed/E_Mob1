...
namespace E_mob_shoppy.DataAccess.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "offers",
                columns: new[] { "OfferId", "OfferDescription", "OfferDiscount", "OfferName", "Offertype" },
                values: new object[,]
                {
                    { 1, "Clearance items at discounted prices", 10.0, "Summer Offer", "Product" },
                    { 2, "up 30 price at discounted ", 20.98, "ChristmasOffer", "Category" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Category_Id", "ListPrice", "Listprice100", "Listprice50", "Price", "ProductDescription", "ProductName", "ProductQuantity" },
                values: new object[,]
                {
                    { 1, 1, 620000.0, 50000.0, 57000.0, 59900.0, "iPhone 15. boasts an advanced dual-camera system that allows you to click mesmerising pictures with immaculate clarity. Furthermore, the lightning-fast A15 Bionic chip allows for seamless multitasking, elevating your performance to a new dimension. A big leap in battery life, a durable design, and a bright Super Retina XDR display facilitate boosting your user experience.", "Apple iPhone 15", 1000 },
                    { 2, 1, 660000.0, 49000.0, 51000.0, 52900.0, "Samsung zfold. boasts an advanced dual-camera system that allows you to click mesmerising pictures with immaculate clarity. Furthermore, the lightning-fast A15 Bionic chip allows for seamless multitasking, elevating your performance to a new dimension. A big leap in battery life, a durable design, and a bright Super Retina XDR display facilitate boosting your user experience.", "Samsung z Fold", 1000 },
                    { 3, 1, 620000.0, 50000.0, 57000.0, 59900.0, "\r\niPhone 13. boasts an advanced dual-camera system that allows you to click mesmerising pictures with immaculate clarity. Furthermore, the lightning-fast A15 Bionic chip allows for seamless multitasking, elevating your performance to a new dimension. A big leap in battery life, a durable design, and a bright Super Retina XDR display facilitate boosting your user experience.", "Apple iPhone 13", 1000 }
                });
